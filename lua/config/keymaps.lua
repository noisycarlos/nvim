...
vim.keymap.set("", "<m-t>", "<cmd>CodeiumToggle<cr>", { noremap = true, desc = "Toggle Codeium" })
...
-------------------- Aerial
vim.keymap.set("n", "<leader>fu", "<cmd>Telescope jumplist<CR>", { noremap = true, desc = "Jumplist" })
vim.keymap.set("n", "<leader>fj", "<cmd>Telescope aerial<CR>", { noremap = true, desc = "Search Symbols" })
vim.keymap.set("n", "<leader>fh", ":AerialNavToggle<CR>", { noremap = true, desc = "Navigate Symbols" })
