...
These are for you, the reader to help understand what is happeni
ng. Feel free to delete
...
vim.keymap.set('n', '<leader>o', require('telescope.builtin').loclist, { desc = '[?] Find recently opened files' })
...
vim.keymap.set('n', '<leader>ww', require('telescope.builtin').grep_string, { desc = '[S]earch current [W]ord' })
...
vim.api.nvim_set_keymap('n', '<leader>,', '<C-w>o', { noremap = true })
vim.api.nvim_set_keymap('n', '<M-e>', 'ddkP', { noremap = true })
vim.api.nvim_set_keymap('n', '<M-n>', 'ddp', { noremap = true })
...
vim.api.nvim_set_keymap('n', '<F5>', ':!go build .<CR>', { noremap = true })
vim.api.nvim_set_keymap('n', '<F5>', ':!go run .<CR>', { noremap = true })


vim.api.nvim_set_keymap('n', '<leader>1', ':cd ~/source/repos/Syncopotamus/Syncopotamus-go<CR>', { noremap = true })
vim.api.nvim_set_keymap('n', '<leader>2', ':cd K:/Dropbox/Carlos/Documents/AutoHotkey/Function Keys<CR>', { noremap = true })
